    ...
    <section className="container flex flex-col px-4 py-6">
      <div className="flex flex-col">
        ...
        <p className="text-balance text-neutral-700">
          ...
          et
          {" "}
          <b>d&apos;entretien de jardin</b>
          {" "}
          à un spécialiste. L&apos;entreprise Garland, située près de Fontainebleau en
          {" "}
          <b>Seine-et-Marne</b>
          , intervient auprès
          {" "}
          <b>des particuliers et des professionnels</b>
          {" "}
          pour aménager et entretenir tous types d&apos;espaces verts.
        </p>
