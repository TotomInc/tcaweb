...
export function ContactCta({ className, ...props }: Props) {
  return (
    <Link
      ...
      href="/contact"
      className={twMerge(
        "group text-primary font-heading relative flex items-center gap-2.5 rounded-full border border-blue-700 bg-white px-7 py-3 text-base font-semibold tracking-tight inset-ring-2 inset-shadow-sm shadow-md inset-shadow-blue-600/50 inset-ring-blue-600/20 focus:ring-2 focus:ring-blue-600/75 focus:outline-none",
        className,
      )}
    >
      Un projet ?{" "}
